...
public class WXAppletUserInfo {
    ...
    public static String getSessionKeyOropenid(String code) {
        ...
        requestUrlParam.put("appid", "wxb5392f7080159c56");    //开发者设置中的appId
        requestUrlParam.put("secret", "e1fc9c1d85e4a039f077968f0e226e64");    //开发者设置中的appSecret
        requestUrlParam.put("js_code", wxCode);    //小程序调用wx.login返回的code
        requestUrlParam.put("grant_type", "authorization_code");    //默认参数

        //发送post请求读取调用微信 https://api.weixin.qq.com/sns/jscode2session 接口获取openid用户唯一标识
        return sendPost(Config.WX_REQUEST_URL, requestUrlParam);
    }
